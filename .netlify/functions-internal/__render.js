...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-6de6551d.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-6de6551d.js", assets + "/_app/chunks/vendor-396d2fa2.js"]
    },
    fetched: void 0,
    floc: false,
...
var manifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      pattern: /^\/bulma-demo\/?$/,
      params: empty,
      a: ["src/routes/__layout.svelte", "src/routes/bulma-demo.svelte"],
      b: [".svelte-kit/build/components/error.svelte"]
    },
    {
      type: "page",
...
var module_lookup = {
  ...
  "src/routes/bulma-demo.svelte": () => Promise.resolve().then(function() {
    return bulmaDemo;
  }),
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-7f84f53b.js", "css": ["assets/pages/__layout.svelte-f1f4d850.css"], "js": ["pages/__layout.svelte-7f84f53b.js", "chunks/vendor-396d2fa2.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-7fdfdafd.js", "css": [], "js": ["error.svelte-7fdfdafd.js", "chunks/vendor-396d2fa2.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-6cd7cc5d.js", "css": ["assets/pages/index.svelte-1ae03b51.css"], "js": ["pages/index.svelte-6cd7cc5d.js", "chunks/vendor-396d2fa2.js"], "styles": [] }, "src/routes/bulma-demo.svelte": { "entry": "pages/bulma-demo.svelte-80163cdd.js", "css": [], "js": ["pages/bulma-demo.svelte-80163cdd.js", "chunks/vendor-396d2fa2.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-ccc6de86.js", "css": ["assets/pages/about.svelte-bf4528fa.css"], "js": ["pages/about.svelte-ccc6de86.js", "chunks/vendor-396d2fa2.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "pages/todos/index.svelte-b27027ae.js", "css": ["assets/pages/todos/index.svelte-784042c1.css"], "js": ["pages/todos/index.svelte-b27027ae.js", "chunks/vendor-396d2fa2.js"], "styles": [] } };
...
var Bulma_demo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<nav class="${"navbar"}" role="${"navigation"}" aria-label="${"main navigation"}"><div class="${"navbar-brand"}"><a class="${"navbar-item"}" href="${"https://bulma.io"}"><img src="${"https://bulma.io/images/bulma-logo.png"}" alt="${"bulma-logo"}" width="${"112"}" height="${"28"}"></a>

        <a href="${"/home"}" role="${"button"}" class="${"navbar-burger"}" aria-label="${"menu"}" aria-expanded="${"false"}" data-target="${"navbarBasicExample"}"><span aria-hidden="${"true"}"></span>
            <span aria-hidden="${"true"}"></span>
            <span aria-hidden="${"true"}"></span></a></div>

    <div id="${"navbarBasicExample"}" class="${"navbar-menu"}"><div class="${"navbar-start"}"><a href="${"/home"}" class="${"navbar-item"}">Home </a>

            <a href="${"/docs"}" class="${"navbar-item"}">Documentation </a>

            <div class="${"navbar-item has-dropdown is-hoverable"}"><a href="${"/more"}" class="${"navbar-link"}">More </a>

                <div class="${"navbar-dropdown"}"><a href="${"/about"}" class="${"navbar-item"}">About </a>
                    <a href="${"/jobs"}" class="${"navbar-item"}">Jobs </a>
                    <a href="${"/contact"}" class="${"navbar-item"}">Contact </a>
                    <hr class="${"navbar-divider"}">
                    <a href="${"/report-issue"}" class="${"navbar-item"}">Report an issue </a></div></div></div>

        <div class="${"navbar-end"}"><div class="${"navbar-item"}"><div class="${"buttons"}"><button class="${"button is-primary"}"><strong>Sign up</strong></button>
                    <button class="${"button is-light"}">Log in </button></div></div></div></div></nav>

<h1 class="${"is-size-1"}">Buttons</h1>

<button class="${"button mb-3"}">Button</button>

<div class="${"buttons"}"><button class="${"button is-primary"}">Primary</button>
    <button class="${"button is-link"}">Link</button></div>
...
<div class="${"select"}"><select><option value="${"Select dropdown"}">Select dropdown</option><option value="${"With options"}">With options</option></select></div>

<h1 class="${"is-size-1"}">Table</h1>

<table class="${"table is-hoverable"}"><thead><tr><th><abbr title="${"Position"}">Pos</abbr></th>
            <th>Team</th>
    ...
    <tbody><tr><th>1</th>
            ...
            <td>+32</td>
            <td>81</td>
            <td>Qualification for the <a href="${"https://en.wikipedia.org/wiki/2016%E2%80%9317_UEFA_Champions_League#Group_stage"}" title="${"2016\u201317 UEFA Champions League"}">Champions League group stage</a></td></tr>
        <tr><th>2</th>
        ...
        <tr><th>4</th>
            ...
            <td>+30</td>
            <td>66</td>
            <td>Qualification for the <a href="${"https://en.wikipedia.org/wiki/2016%E2%80%9317_UEFA_Champions_League#Play-off_round"}" title="${"2016\u201317 UEFA Champions League"}">Champions League play-off round</a></td></tr></tbody></table>

<h1 class="${"is-size-1"}">Columns / Flexbox</h1>
<div class="${"columns has-text-centered"}"><div class="${"column has-background-primary m-2 box"}">First column</div>
    ...
    <div class="${"column has-background-primary m-2 box"}">Fourth column</div></div>

<h1 class="${"is-size-1"}">Pagination</h1>
<nav class="${"pagination"}" role="${"navigation"}" aria-label="${"pagination"}"><button class="${"button pagination-previous"}">Previous</button>
    <button class="${"button pagination-next"}">Next page</button>
    <ul class="${"pagination-list"}"><li><button class="${"button pagination-link"}" aria-label="${"Goto page 1"}">1</button></li>
        <li><span class="${"pagination-ellipsis"}">\u2026</span></li>
        <li><button class="${"button pagination-link"}" aria-label="${"Goto page 45"}">45</button></li>
        <li><button class="${"button pagination-link is-current"}" aria-label="${"Page 46"}" aria-current="${"page"}">46</button></li>
        <li><button class="${"button pagination-link"}" aria-label="${"Goto page 47"}">47</button></li>
        <li><span class="${"pagination-ellipsis"}">\u2026</span></li>
        <li><button class="${"button pagination-link"}" aria-label="${"Goto page 86"}">86</button></li></ul></nav>`;
});
var bulmaDemo = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  "default": Bulma_demo
});
